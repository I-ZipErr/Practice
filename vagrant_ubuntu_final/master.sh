...
iptables -I INPUT 1 -p tcp --match multiport --dports 6443,10248,2379:2380,10250:10252 -j ACCEPT
...
sudo systectl restart systemd-hostnamed
...
#sudo kubeadm join 172.16.0.1:6443 --token l4yiic.826bu0xorsnzltx0 --discovery-token-ca-cert-hash sha256:d5cb164f38452da7b59cc883ac2c02a47b5f4f4510671b7b97e0106ecb2a5240 --cri-socket=unix:///var/run/cri-dockerd.sock
